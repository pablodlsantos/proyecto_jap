...
function showArticlesArray(){
    ...
    for (let i = 0; i < articlesArray.length; i++){ // Formatting the html
        ...
        <td class="fw-bold" id="${articlesArray[i].id}-cost">${articlesArray[i].currency} ${articlesArray[i].unitCost}</td>
        ...
        //let count = articlesArray[i].count;
        //userInput.setAttribute("value", count);
